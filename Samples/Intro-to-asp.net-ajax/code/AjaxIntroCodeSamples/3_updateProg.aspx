<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="3_updateProg.aspx.cs" Inherits="AjaxIntroCodeSamples.__updateProg" %>
...
<head id="Head1" runat="server">
    ...
    <style type="text/css">
        .error{color: #f00;}
        .message{color: #000;}
        .loading{height: 32px; width: 132px; margin: 8px;}
    </style>
</head>
<body>
